...
class Taka_Tour_Data {
	const EVENT_POST_TYPE = 'taka_event';
	const ORGANIZER_POST_TYPE = 'taka_organizer';
	const VENUE_POST_TYPE = 'taka_venue';
	...
	public static function pretix_event_url( $event ) { return Taka_Tour_Ticket_Providers::pretix_widget_url( $event ); }
