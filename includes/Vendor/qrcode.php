...
define(__NAMESPACE__ . "\\QR_PAD0", 0xEC);
define(__NAMESPACE__ . "\\QR_PAD1", 0x11);
...
define(__NAMESPACE__ . "\\QR_G15", (1 << 10) | (1 << 8) | (1 << 5)
    | (1 << 4) | (1 << 2) | (1 << 1) | (1 << 0) );

define(__NAMESPACE__ . "\\QR_G18", (1 << 12) | (1 << 11) | (1 << 10)
    | (1 << 9) | (1 << 8) | (1 << 5) | (1 << 2) | (1 << 0) );

define(__NAMESPACE__ . "\\QR_G15_MASK", (1 << 14) | (1 << 12) | (1 << 10)
    | (1 << 4) | (1 << 1) );
...
define(__NAMESPACE__ . "\\QR_MODE_NUMBER", 1 << 0);
define(__NAMESPACE__ . "\\QR_MODE_ALPHA_NUM", 1 << 1);
define(__NAMESPACE__ . "\\QR_MODE_8BIT_BYTE", 1 << 2);
define(__NAMESPACE__ . "\\QR_MODE_KANJI", 1 << 3);

//---------------------------------------------------------------
// MaskPattern
//---------------------------------------------------------------

define(__NAMESPACE__ . "\\QR_MASK_PATTERN000", 0);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN001", 1);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN010", 2);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN011", 3);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN100", 4);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN101", 5);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN110", 6);
define(__NAMESPACE__ . "\\QR_MASK_PATTERN111", 7);

//---------------------------------------------------------------
// ErrorCorrectLevel

// 7%.
define(__NAMESPACE__ . "\\QR_ERROR_CORRECT_LEVEL_L", 1);
// 15%.
define(__NAMESPACE__ . "\\QR_ERROR_CORRECT_LEVEL_M", 0);
// 25%.
define(__NAMESPACE__ . "\\QR_ERROR_CORRECT_LEVEL_Q", 3);
// 30%.
define(__NAMESPACE__ . "\\QR_ERROR_CORRECT_LEVEL_H", 2);
